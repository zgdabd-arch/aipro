...
function DashboardPage() {
    ...
    const studentProfilesQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$hooks$2f$use$2d$memo$2d$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "DashboardPage.useMemoFirebase[studentProfilesQuery]": ()=>{
    ...
    const studyPlanQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$hooks$2f$use$2d$memo$2d$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "DashboardPage.useMemoFirebase[studyPlanQuery]": ()=>{
    ...
    const { data: studyPlans, isLoading: isLoadingPlans } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(studyPlanQuery);
    const latestStudyPlan = studyPlans?.[0];
    // Memoize the query for progress on the latest study plan
    const progressQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$hooks$2f$use$2d$memo$2d$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "DashboardPage.useMemoFirebase[progressQuery]": ()=>{
            if (!user || !firestore || !studentProfile || !latestStudyPlan) return null;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, `users/${user.uid}/studentProfiles/${studentProfile.id}/studyPlans/${latestStudyPlan.id}/progress`);
        }
    }["DashboardPage.useMemoFirebase[progressQuery]"], [
        user,
        firestore,
    ...
    const { data: progressData, isLoading: isLoadingProgress } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(progressQuery);
    const { chartData, totalMinutes, lessonsCompleted } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo": ()=>{
            const now = new Date();
            const yearStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfYear"])(now);
            const yearEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfYear$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endOfYear"])(now);
            ...
            const initialData = months.map({
                "DashboardPage.useMemo.initialData": (monthDate)=>({
                        date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(monthDate, 'MMM'),
                        minutes: 0
                    })
            }["DashboardPage.useMemo.initialData"]);
            if (!progressData) {
                return {
            ...
            const { aggregatedData, totalMinutes } = progressData.reduce({
                "DashboardPage.useMemo": (acc, progress)=>{
                    if (!progress.date) return acc;
                    const progressDate = progress.date?.toDate ? progress.date.toDate() : new Date(progress.date);
                    const month = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(progressDate, 'MMM');
                    const sessionMinutes = progress.duration || 0;
                    acc.totalMinutes += sessionMinutes;
                    const monthIndex = acc.aggregatedData.findIndex({
                        "DashboardPage.useMemo.monthIndex": (d)=>d.date === month
                    }["DashboardPage.useMemo.monthIndex"]);
                    if (monthIndex > -1) {
            ...
            return {
                ...
                totalMinutes,
                lessonsCompleted: uniqueCompletedSessions.size
            };
        }
    }["DashboardPage.useMemo"], [
        progressData
    ...
    const currentProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[currentProgress]": ()=>{
        ...
        "DashboardPage.useMemo[stats]": ()=>{
            ...
            return [
                ...
                },
                {
                    ...
                    change: `of ${latestStudyPlan?.schedule?.length || 0} planned`
                },
                {
                    title: 'Current Goal',
                    value: latestStudyPlan?.subject || 'N/A',
                    icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$target$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Target$3e$__["Target"],
                    change: 'Latest study plan'
                },
                {
                    title: 'Active Days',
                    value: new Set(progressData?.map({
                        "DashboardPage.useMemo[stats]": (p)=>p.date?.toDate ? p.date.toDate().toDateString() : new Date(p.date).toDateString()
                    }["DashboardPage.useMemo[stats]"])).size,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Your study minutes over the last year."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                        lineNumber: 140,
                                        columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                        children: "Current Goal Progress"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                        lineNumber: 175,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: latestStudyPlan?.subject ? `Progress on ${latestStudyPlan.subject}` : 'No active study plan'
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                        lineNumber: 176,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: latestStudyPlan && latestStudyPlan.schedule ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$progress$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Progress"], {
                                                ...
                                                "aria-label": `${currentProgress}% progress on current goal`
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                                lineNumber: 186,
                                                columnNumber: 25
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    children: "You're making great progress. Keep up the momentum!"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                                    lineNumber: 188,
                                                    columnNumber: 29
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                children: "No study plan has been generated yet."
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                                lineNumber: 193,
                                                columnNumber: 25
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-sm",
                                                children: 'Go to the "Study Plan" page to create one.'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                                lineNumber: 194,
                                                columnNumber: 25
...
_s(DashboardPage, "I/+H542V6YTMVmFV1MJSh0rFcek=", false, function() {
    return [
...
//# sourceMappingURL=src_f33088ac._.js.map